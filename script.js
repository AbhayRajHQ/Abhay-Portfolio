...
(async function boot() {
  ...
  pre.classList.add('split'); // fades terminal + slides panels simultaneously
...
const heroMsgs = [
  ...
  'This is the most productive procrastination I\'ve ever witnessed.',
  'You know what? I like you. Don\'t tell anyone.',
  'Fun fact: I built this button specifically for people like you.',
  'Still? I admire you. Most give up at three clicks.',
...
const skillData = {
  html5: {
    ...
    body2: 'Why it matters: Every website ever built uses HTML. HTML5 adds native features like canvas, video/audio, and semantic tags that improve accessibility and SEO. The non-negotiable first language of the web.',
  ...
  css3: {
    ...
    body2: 'Why it matters: Modern CSS with Flexbox and Grid builds complex, responsive layouts. CSS animations create polished experiences. It\'s what separates a blank document from a real product.',
  ...
  tailwind: {
    ...
    body2: 'Why it matters: Widely adopted in professional projects because it accelerates development without losing flexibility. It teaches design system thinking and is the most popular CSS framework in modern web dev.',
    chips: ['Utility-first', 'Design system', 'Rapid dev', 'Industry standard']
  },
  javascript: {
    icon: '⚡', title: 'JavaScript', tag: 'CURRENT STACK · INTERACTIVITY · FULL-STACK',
    ...
    body2: 'Why it matters: One of the most important languages to master. With Node.js it powers servers. With React/Vue it builds complex apps. Mastering JS opens more doors than almost any other technology.',
    chips: ['Interactivity', 'APIs', 'DOM', 'Node.js', 'Full-stack']
  },
  python: {
    icon: '🐍', title: 'Python', tag: 'CURRENTLY LEARNING · BACKEND · AI/ML GATEWAY',
    body: 'Python is one of the most versatile and readable languages ever made. Used in web backends, data science, AI/ML, scripting, and automation.',
    body2: 'Why it matters: Its simple syntax makes it fast to learn. It\'s the primary language for AI/ML — directly aligned with your roadmap. Django and Flask power major backends. Learning Python now prepares you for AI later.',
  ...
  backend: {
    ...
    body: 'The backend is everything users never see but always depend on — servers, databases, APIs, authentication, and data management. The engine beneath every application.',
    body2: 'Why it matters: Understanding backends makes you a full-stack engineer. It\'s what lets you build apps that store data, serve real users, handle logins, and communicate with external services.',
    chips: ['Servers', 'Databases', 'REST APIs', 'Authentication', 'Full-stack']
  },
  cpp: {
    icon: '⚙️', title: 'C / C++', tag: 'ROADMAP · SYSTEMS · LOW-LEVEL',
    body: 'C and C++ are low-level languages that give direct control over memory and hardware. C is the foundation of operating systems and embedded systems. C++ extends it with object-oriented features.',
    body2: 'Why it matters: Learning C teaches exactly how computers work at hardware level. It makes you a stronger programmer in every other language. Essential for DSA mastery and high-performance software.',
  ...
  dsa: {
    ...
    body: 'DSA is the science of organising and processing data efficiently. Arrays, linked lists, trees, graphs, sorting, searching — the building blocks of all efficient software.',
    body2: 'Why it matters: DSA separates good engineers from great ones. Core of technical interviews at every major company. It teaches you to think about time and memory complexity — skills that determine if your code scales.',
  ...
  aiml: {
    ...
    body: 'Machine learning teaches computers to learn patterns from data rather than explicit rules. Neural networks, classification, NLP, computer vision — reshaping every industry.',
    body2: 'Why it matters: AI/ML is not the future — it\'s the present. Your Python foundation leads directly here. Understanding ML models will be a core engineering skill within a decade.',
  ...
  cybersecurity: {
    ...
    body: 'Cybersecurity is about understanding how systems can be broken in order to build them safer. Cryptography, network security, authentication, secure coding, and ethical hacking.',
    body2: 'Why it matters: Every application you build needs to be secure. Understanding attack vectors, input validation, and encryption makes you a more responsible and complete developer.',
...
const interestData = {
  calisthenics: {
    ...
    body: 'I train calisthenics not just to build the body, but to build the mind. The discipline required to show up, push through failure, and improve incrementally mirrors everything I believe about building.',
    body2: 'Every rep is a system in motion — input, feedback, adaptation. The same loop I run with code.',
    chips: ['Discipline', 'Resilience', 'Consistency', 'Self-mastery']
  },
  swimming: {
    icon: '🏊', title: 'Swimming', tag: 'ENDURANCE · RHYTHM · MENTAL CLARITY',
    body: 'Swimming is meditation in motion. The rhythm of strokes, the silence underwater, the demand for endurance — it teaches you to be comfortable in discomfort.',
    body2: 'A skill I\'m building toward. The best challenges are the ones you choose deliberately.',
    chips: ['Endurance', 'Rhythm', 'Mental clarity', 'Patience']
  },
  boxing: {
    icon: '🥊', title: 'Boxing', tag: 'FOCUS · STRATEGY · COMPOSURE',
    body: 'Boxing is chess at full speed. Every movement is intentional. It demands composure under pressure, strategic thinking, and controlled power — never wasted energy.',
    body2: 'Qualities I bring into problem-solving. An aspiration fuelling my drive for focused growth.',
  ...
  guitar: {
    ...
    body2: 'Creativity is the counterbalance to pure logic. I need both to build anything worth remembering.',
...
const cmds = {
  ...
  'fun-fact': [
    ...
    '  → Debugging 5 things simultaneously right now',
    '  → Calisthenics and coding share the same core loop'
  ]
};
